...
namespace CluedIn.Crawling.Geometic.ClueProducers
{
    public class BusinessCustomerClueProducer : BaseClueProducer<BusinessCustomer>
    {
        ...
        public BusinessCustomerClueProducer(IClueFactory factory)
        {
            _factory = factory;
        }

        protected override Clue MakeClueImpl(BusinessCustomer input, Guid id)
        {

            var clue = _factory.Create(EntityType.Organization, input.KUNLOEB, id);//ToDo EntityType...
            ...
            var vocab = Geomatic.Vocabularies.GeomaticVocabularies.BusinessCustomer;
